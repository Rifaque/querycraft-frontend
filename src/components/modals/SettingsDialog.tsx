                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                     <div className="flex items-center justify-between">
                       <Label>Theme</Label>
                       <select value={profile.preferences.theme} onChange={(e) => setProfile(p => ({...p, preferences: {...p.preferences, theme: e.target.value as any}}))} className="bg-transparent border rounded-md p-2">
